...
│   ├── 04-信令与连接建立.md    ← 【骨架+4.0/4.3已填充】HTTPS/WSS、TURN、ICE 候选与探测
...
| 04 信令与连接建立 | 🟡 骨架 + 4.0/4.3 已填充 | 2026-09-10 | TURN(4.0.3)、ICE 候选与探测(4.3) 已完成；待补 Offer-Answer(4.2)/DTLS/SRTP(4.4)/服务端剖析(4.5) |
